...
ChangeEditEntityCommand::ChangeEditEntityCommand(EntityInspectorArea* _inspectorArea,const OriGine::EntityHandle& _toHandle,const OriGine::EntityHandle& _fromHandle)
...
ChangeEntityNameCommand::ChangeEntityNameCommand(EntityInspectorArea* _inspectorArea,const OriGine::EntityHandle& _entityHandle,const ::std::string& _newName)
...
DeleteEntityCommand::DeleteEntityCommand(EntityInspectorArea* _parentArea,const EntityHandle& _entityHandle)
...
RemoveComponentForEntityCommand::RemoveComponentForEntityCommand(Scene* _scene,const ::std::string& _componentTypeName,const EntityHandle& _entityHandle,int32_t _compIndex)
