...
public:
    ...
    void Initialize(OriGine::Scene* _scene, OriGine::EntityHandle _entity) = 0;

    virtual void Edit(Scene* _scene, EntityHandle _entity, const std::string& _parentLabel) override = 0;
