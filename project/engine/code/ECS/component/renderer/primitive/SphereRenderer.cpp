...
void SphereRenderer::Initialize(Scene* _scene, EntityHandle _hostEntity) {
...
void SphereRenderer::Edit([[maybe_unused]] Scene* _scene, [[maybe_unused]] EntityHandle _handle, [[maybe_unused]] const std::string& _parentLabel) {
#ifdef _DEBUG
