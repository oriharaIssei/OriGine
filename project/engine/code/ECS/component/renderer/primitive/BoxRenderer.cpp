...
void OriGine::to_json(nlohmann::json& _j, const BoxRenderer& _comp) {
    ...
    _j["size"] = _comp.primitive_.halfSize_;
}

void OriGine::from_json(const nlohmann::json& _j, BoxRenderer& _comp) {
    ...
    _j.at("size").get_to(_comp.primitive_.halfSize_);
}
