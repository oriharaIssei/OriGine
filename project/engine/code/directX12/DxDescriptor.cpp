...
Microsoft::WRL::ComPtr<ID3D12DescriptorHeap> OriGine::CreateHeap(Microsoft::WRL::ComPtr<ID3D12Device> device, D3D12_DESCRIPTOR_HEAP_TYPE heapType, UINT numDescriptors, bool shaderVisible) {
    HRESULT hr;
