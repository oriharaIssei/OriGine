...
void EmitterAABB::Debug() {
    ImGui::DragFloat3("min", reinterpret_cast<float*>(min_.operator Vec3f*()), 0.1f);
    ImGui::DragFloat3("max", reinterpret_cast<float*>(max_.operator Vec3f*()), 0.1f);
    min_.setValue(
