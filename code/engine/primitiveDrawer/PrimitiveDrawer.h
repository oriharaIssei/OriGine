...
public:
	...
	static void Line(const Vector3 &p0,const Vector3 &p1,const TransformBuffer &TransformBuffer,const ViewProjection &viewProj,const Material *material);
	static void Triangle(const Vector3 &p0,const Vector3 &p1,const Vector3 &p2,const TransformBuffer &TransformBuffer,const ViewProjection &viewProj,const Material *material);
	static void Quad(const Vector3 &p0,const Vector3 &p1,const Vector3 &p2,const Vector3 &p3,const TransformBuffer &TransformBuffer,const ViewProjection &viewProj,const Material *material);
