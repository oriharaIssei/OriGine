...
void CameraAction::Initialize(Scene* /*_scene*/, const EntityHandle& /*_entity*/) {}

void CameraAction::Edit(Scene* /*_scene*/, const EntityHandle& /*_entity*/, [[maybe_unused]] const std::string& _parentLabel) {
